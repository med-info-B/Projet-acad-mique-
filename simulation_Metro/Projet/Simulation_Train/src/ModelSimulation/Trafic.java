...
public class Trafic {
	...
	public Trafic creatTrafic() {
		...
		Station s1 = new TerminusLine(new Coordinate     (1,2),       "Saint-Lazare");
		Station s2 = new StationNormal(new   Coordinate  (3,2),       "Madeleine");
		Station s3 = new StationNormal(new   Coordinate  (5,2),       "Pyramide");	
		Station s4 = new StationNormal(new   Coordinate  (7,2),       "Châtelet");
		Station s5 = new TerminusZone(new   Coordinate   (9,2),      " Gare de lyon");
